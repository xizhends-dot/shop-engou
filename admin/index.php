...
<nav class="adm-pager" aria-label="ページ送り">
  <?php if ($page > 1): ?><a class="adm-pager-btn" href="index.php?page=<?= $page - 1 ?>"><i class="fa-solid fa-chevron-left"></i></a><?php endif; ?>
  <?php for ($i = 1; $i <= $pages; $i++): ?>
    <?php if ($i === $page): ?><span class="adm-pager-num active"><?= $i ?></span>
    <?php else: ?><a class="adm-pager-num" href="index.php?page=<?= $i ?>"><?= $i ?></a><?php endif; ?>
  <?php endfor; ?>
  <?php if ($page < $pages): ?><a class="adm-pager-btn" href="index.php?page=<?= $page + 1 ?>"><i class="fa-solid fa-chevron-right"></i></a><?php endif; ?>
</nav>
